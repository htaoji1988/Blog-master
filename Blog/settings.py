...
WEBSITE_TITLE = '海涛的BLOG'
WEBSITE_WELCOME = '你是不是傻'
WEBSITE_SEO_KEYWORD = '网站SEO关键词'
WEBSITE_SEO_DESCRIPTION = '记录一些生活和工作'

CONSTANCE_CONFIG = OrderedDict([
    (WEBSITE_TITLE, ('海涛的BLOG', WEBSITE_TITLE)),
    (WEBSITE_WELCOME, ('你是不是二？', WEBSITE_TITLE)),
...
EMAIL_HOST_USER = 'htaoji1988@126.com'  # 邮箱账户
EMAIL_HOST_PASSWORD = 'Ht511301'  # 邮箱密码\授权码
EMAIL_SUBJECT_PREFIX = u'HTBlog'  # 为邮件Subject-line前缀,默认是'[django]'
EMAIL_USE_TLS = False  # 与SMTP服务器通信时，是否启动TLS链接(安全链接)。默认是false
DEFAULT_FROM_EMAIL = 'HT<htaoji1988@126.com>'
